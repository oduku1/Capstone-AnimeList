...
export default function SingleAnime() {
  ...
  const { openPopup, setOpenPopup, selectedAnime, setSelectedAnime, user } =
  ...
  return (
    <div className="anime-main-content">
      ...
      <div className="anime-page-left">
        ...
        <p>
          Genres: {selectedAnime.genres.map((genre) => genre.name).join(", ")}
        </p>
        <p>
          Aired: From {getAirDate(selectedAnime?.aired?.from)} To{" "}
          {getAirDate(selectedAnime?.aired?.to)}{" "}
        </p>
      ...
      <div className="anime-page-right">
        ...
        <div className="summary">
          <h4>Information</h4>
          <p>
            <strong>Aired:</strong> {selectedAnime.aired?.string || "Unknown"}
          </p>
          <p>
          ...
          <p>
            <strong>Score:</strong> {selectedAnime.score || "No score yet"}
          </p>
        </div>
